...
/*   Updated: 2022/02/12 20:57:16 by llornel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static int	ft_read(t_listfd *lstfd, int fd)
{
	char	*buffer;
	char	*tmp_str;
	int		byte_read;
...
static int	ft_get_str_from_line(t_listfd *lstfd, char **line)
{
	char	*tmp_str;
	char	*endl_str;
	int		ret;
